...
%      NONE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function hit_or_miss_image = HitorMissTransform2(binary_image)
    ...
    padded_image = padarray(binary_image, pad_fg, 'both');
    padded_image_inv = padarray(~binary_image, pad_bg, 'both');
